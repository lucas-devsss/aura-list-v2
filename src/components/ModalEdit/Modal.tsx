    ...
    return(
        <dialog ref={dialogRef} className={styles.modal}>
                <div className={styles["edit-actions"]}>
                    ...
                    <input type="text" value={editTask.name} onChange={(e) => handleChangeTask(e.currentTarget.value, editTask.difficulty, editTask.completed)}  name="task-edit-input" id="task-edit-input" className={styles.input}/>
                    <fieldset className={styles["difficulty-container"]}>
                        <legend className={styles.legend}> Edite a dificuldade</legend>
                        <label htmlFor="dificilEdit" className={styles["badge-hard"]}><input type="radio" className={styles["input-radio"]} onChange={(e) => handleChangeTask(editTask.name, e.currentTarget.value as Difficulty, editTask.completed)} name="editDificuldade" id="dificilEdit" value="hard" defaultChecked={editTask.difficulty === "hard"}/>Difícil</label>
                        <label htmlFor="medioEdit" className={styles["badge-medium"]}><input type="radio" className={styles["input-radio"]} onChange={(e) => handleChangeTask(editTask.name, e.currentTarget.value as Difficulty, editTask.completed)} name="editDificuldade" id="medioEdit" value="medium" defaultChecked={editTask.difficulty === "medium"}/>Médio</label>  
